...
# tutor-plugin-configure-courseware-mfe

Installs and enables a tutor plugin to either enable or disable the courseware micro front-end app functionality.
...
## Usage to enable courseware MFE
  ...
  build:
    ...
    steps:
      ...
      - name: Enable tutor plugin - MFE
        uses: openedx-actions/tutor-enable-plugin-mfe@v1.0.0
        with:
